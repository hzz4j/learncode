...
public class AutoConfigureRead {
     ...
     * @return
     */
    public static List<String> readFile(Class<?> annotation, ClassLoader classLoader){
        String location = String.format(LOCATION, annotation.getName());
        Enumeration<URL> urlsInClasspath = findUrlsInClasspath(classLoader, location);
