package org.hzz.ddd.interfaces.booking.web;
...
import org.hzz.ddd.interfaces.booking.facade.dto.LegDTO;
 ...
 *
 * @see org.hzz.ddd.interfaces.tracking.CargoTrackingController
 */
@Controller
...
public class CargoAdminController {
    ...
    public String registration(HttpServletRequest request, HttpServletResponse response, ModelMap model) throws Exception {
